...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'bayyou@houtlook.me',
  ...
  title: "BluRay.id ODrive",

  // The folder that you are to share publicly with onedrive-vercel-index. Use '/' if you want to share your root folder.
  baseDirectory: '/blurray.id',
  ...
  email: 'mailto:bluray.id@gmail.com',
